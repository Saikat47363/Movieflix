...
public class Seriesdashboard implements ActionListener{
	JFrame Frame6;
	...
	public Seriesdashboard()
	{
		...
		//MOVIE 2
		m2 = new JButton();
        m2.setIcon(new ImageIcon("images/got170.jpg"));
        m2.setBounds(485, 90, 170, 255);
        m2.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m2.addActionListener(this);
        m2lbl = new JButton("Game of Thrones");
		...
		//MOVIE 6
		m6 = new JButton();
        m6.setIcon(new ImageIcon("images/twatcher170.jpg"));
        m6.setBounds(265, 400, 170, 255);
        m6.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m6.addActionListener(this);
        m6lbl = new JButton("The Watcher");
		...
		//MOVIE 11
		m11 = new JButton();
        m11.setIcon(new ImageIcon("images/hannibal170.jpg"));
        m11.setBounds(45, 90, 170, 255);
        m11.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m11.addActionListener(this);
        m11lbl = new JButton("Hannibal");
		...
		//MOVIE 12
		m12 = new JButton();
        m12.setIcon(new ImageIcon("images/aouad170.jpg"));
        m12.setBounds(45, 400, 170, 255);
        m12.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m12.addActionListener(this);
        m12lbl = new JButton("All of Us Are Dead");
