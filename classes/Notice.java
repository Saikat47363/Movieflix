...
public class Notice implements ActionListener{
	...
	public Notice()
	{
		...
		//PROJECT NAME
		lbl = new JLabel("SHORT NOTICE");
		lbl.setBounds(550,90,400,40);
        ...
        table.getColumnModel().getColumn(0).setPreferredWidth(680);
        ...
        String file = "data\\user\\user_notice.txt";
        ...
        try {
            ...
            for (int i = 0; i < totalLines; i++)
			{
                ...
                if (x.equals("Not"))
				{
                    rows[0] = Files.readAllLines(Paths.get(file)).get(i).substring(8); // Notice
                    model.addRow(rows);
                }
            }
