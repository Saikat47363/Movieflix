...
public class Mail implements ActionListener{
	...
	private JLabel  background,pageName,adminlbl;
	...
	private String[] column = { "User Name", "Problem"};
	...
	public Mail()
	{
        ...
        Frame.add(scroll);
		 ...
		 String file = "data\\admin\\support_mail.txt";
        ...
        try {
            ...
            for (int i = 0; i < totalLines; i++)
			{
                ...
                if (x.equals("User"))
				{
                    ...
                    rows[1] = Files.readAllLines(Paths.get(file)).get((i + 1)).substring(9); // Message
                    model.addRow(rows);
                }
            }
