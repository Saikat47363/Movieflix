...
public class Moviedashboard implements ActionListener{
	JFrame Frame6;
	...
	public Moviedashboard()
	{
		...
		//MOVIE 4
		m4 = new JButton();
        m4.setIcon(new ImageIcon("images/tos170.jpg"));
        m4.setBounds(925, 90, 170, 255);
        m4.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m4.addActionListener(this);
        m4lbl = new JButton("Triangle of Sadness");
		...
		//MOVIE 5
		m5 = new JButton();
        m5.setIcon(new ImageIcon("images/tfios170.jpg"));
        m5.setBounds(1145,90, 170, 255);
        m5.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m5.addActionListener(this);

        m5lbl = new JButton("The Fault In Our Stars");
		...
		//MOVIE 6
		m6 = new JButton();
        m6.setIcon(new ImageIcon("images/abm170.jpg"));
        m6.setBounds(265, 400, 170, 255);
        m6.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m6.addActionListener(this);
        m6lbl = new JButton("A Beautiful Mind");
		...
		//MOVIE 12
		m12 = new JButton();
        m12.setIcon(new ImageIcon("images/tcnj170.jpg"));
        m12.setBounds(45, 400, 170, 255);
        m12.setCursor(new Cursor(Cursor.HAND_CURSOR));
		m12.addActionListener(this);
        m12lbl = new JButton("The Conjuring");
