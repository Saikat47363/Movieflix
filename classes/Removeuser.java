...
public class Removeuser implements ActionListener{
	...
	public Removeuser()
	{
		...
		ad = new JButton("Remove User");
		ad.setBounds(520, 630, 300, 35);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==ad)
		{
			...
			String file1 = "data\\user\\user_login.txt";
			String temp = "data\\user\\user_login_temp.txt";
			...
			if (table.getSelectionModel().isSelectionEmpty())
			{
				...
				try{
						...
						for (int j = 0; j < totalLines; j++)
						{
							...
							if(c != 0 && (j == c || j == (c + 1) || j==(c+2) || j==(c+3) || j==(c+4)))
							{
								//System.out.println("Worked!!");
