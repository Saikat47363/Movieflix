...
public class M10clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M10clickmovie()
	{
		...
		moviename = new JTextField("The Beast");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\The Beast.mp4");
