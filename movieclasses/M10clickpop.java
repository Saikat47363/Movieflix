...
public class M10clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M10clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/12am230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("12 Angry Men");
		...
		moviename = new JTextField("12 Angry Men");
		...
		genre = new JTextField("Drama, Crime");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\12 angry men.mp4");
