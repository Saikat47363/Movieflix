...
public class M12clickseries implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,m1seriesbtn,m1reqbtn,m1backbtn,exitm1,m1popbtn,m1,m1lbl,m2,m2lbl,addlistbtn,s;
	private JPanel m1panel,m1panel3;
	
	public M12clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/aouad230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("All of Us Are Dead");
		...
		moviename = new JTextField("All of Us Are Dead");
		...
		genre = new JTextField("Drama,Action,Fantacy");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\All of us are dead.mp4");
