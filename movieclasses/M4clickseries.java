...
public class M4clickseries implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,s,m1seriesbtn,m1reqbtn,m1backbtn,exitm1,m1popbtn,m1,m1lbl,m2,m2lbl,addlistbtn;
	private JPanel m1panel,m1panel3;
	
	public M4clickseries()
	{
		...
		moviename = new JTextField("First Love");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\First Love.mp4");
