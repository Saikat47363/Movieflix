...
public class M2click implements ActionListener
{
	JFrame Framem1;
	...
	public M2click()
	{
		...
		moviename = new JTextField("Evil Dead");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Evil Dead.mp4");
