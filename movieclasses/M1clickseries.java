...
public class M1clickseries implements ActionListener
{
	JFrame Framem1;
	...
	public M1clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/wed230.jpg"));
		...
		moviename = new JTextField("Wednessday");
		...
		genre = new JTextField("Comedy,Crime,Family");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Wednessday.mp4");
