...
public class M4clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M4clickmovie()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/tos230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Triangle of Sadness");
		...
		moviename = new JTextField("Triangle of Sadness");
		...
		genre = new JTextField("Comedy,Drama");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Triangle of Sadness.mp4");
