...
public class M10clickseries implements ActionListener
{
	JFrame Framem1;
	...
	public M10clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/kf230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Kota Factory");
		...
		moviename = new JTextField("Kota Factory");
		...
		genre = new JTextField("Drama,Comedy");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Kota Factory.mp4");
