...
public class M1clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M1clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/slist230.jpg"));
		...
		moviename = new JTextField("Schindler's List");
		...
		genre = new JTextField("Drama, Biography, History");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Schindlers List.mp4");
