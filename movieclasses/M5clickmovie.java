...
public class M5clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,m1seriesbtn,s,m1reqbtn,m1backbtn,exitm1,m1popbtn,m1,m1lbl,m2,m2lbl,addlistbtn;
	...
	public M5clickmovie()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/tfios230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("The Fault In Our Stars");
		...
		moviename = new JTextField("The Fault In Our Stars");
		...
		genre = new JTextField("Drama,Romance");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\The Fault in our Stars.mp4");
