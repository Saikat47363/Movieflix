...
public class M5clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M5clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/lib230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Life Is Beautiful");
		...
		moviename = new JTextField("Life Is Beautiful");
		...
		genre = new JTextField("Romance, Comedy, Drama");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Life is Beautiful.mp4");
