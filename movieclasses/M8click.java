...
public class M8click implements ActionListener
{
	JFrame Framem1;
	...
	public M8click()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/tlk230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("The Lion King");
		...
		moviename = new JTextField("The Lion King");
		...
		genre = new JTextField("Drama,Animation,Adventure");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\The Lion King.mp4");
