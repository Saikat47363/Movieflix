...
public class M6clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M6clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/cher230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Chernobyl");
		...
		moviename = new JTextField("Chernobyl");
		...
		genre = new JTextField("Drama, History, Thriller");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Chernobyl.mp4");
