...
public class M6clickseries implements ActionListener
{
	JFrame Framem1;
	...
	public M6clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/twatcher230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("The Watcher");
		...
		moviename = new JTextField("The Watcher");
		...
		genre = new JTextField("Drama,Horror,Mystery");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\The Watcher.mp4");
