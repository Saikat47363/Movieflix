...
public class M5click implements ActionListener
{
	JFrame Framem1;
	...
	public M5click()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/mh230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Money Heist");
		...
		moviename = new JTextField("Money Heist");
		...
		release = new JTextField("2017-2021");
		...
		genre = new JTextField("Action,Crime,Drama");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Money Heist.mp4");
