...
public class M1clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M1clickmovie()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/ob230.jpg"));
		...
		moviename = new JTextField("Old Boy");
		...
		genre = new JTextField("Drama,Action,Mystery");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Old Boy.mp4");
