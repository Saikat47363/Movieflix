...
public class M2clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M2clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/ins230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Interstellar");
		...
		moviename = new JTextField("Interstellar");
		...
		genre = new JTextField("Adventure,Drama,Sci-Fi");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Interstellar.mp4");
