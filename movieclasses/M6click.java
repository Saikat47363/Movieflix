...
public class M6click implements ActionListener
{
	JFrame Framem1;
	...
	public M6click()
	{
		...
		moviename = new JTextField("Squid Game");
		...
		genre = new JTextField("Action,Drama,Mystery");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Squid Game.mp4");
