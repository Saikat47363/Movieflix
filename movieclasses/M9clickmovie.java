...
public class M9clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M9clickmovie()
	{
		...
		moviename = new JTextField("Joker");
		...
		genre = new JTextField("Drama,Thriller,Crime");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Joker.mp4");
