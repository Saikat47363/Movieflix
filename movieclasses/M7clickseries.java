...
public class M7clickseries implements ActionListener
{
	JFrame Framem1;
	...
	public M7clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/friends230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Friends");
		...
		moviename = new JTextField("Friends");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Friends.mp4");
