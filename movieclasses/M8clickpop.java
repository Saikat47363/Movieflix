...
public class M8clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M8clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/gladiator230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Gladiator");
		...
		moviename = new JTextField("Gladiator");
		...
		genre = new JTextField("Drama, Action, Adventure");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Gladiator.mp4");
