...
public class M4clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M4clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/tgmile230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("The Green Mile");
		...
		moviename = new JTextField("The Green Mile");
		...
		genre = new JTextField("Fantacy, Crime, Drama");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\The Green Mile.mp4");
