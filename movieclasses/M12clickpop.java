...
public class M12clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M12clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/daredevil230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("DareDevil");
		...
		moviename = new JTextField("DareDevil");
		...
		genre = new JTextField("Drama, Action, Crime");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Daredevil.mp4");
