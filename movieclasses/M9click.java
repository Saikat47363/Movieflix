...
public class M9click implements ActionListener
{
	JFrame Framem1;
	...
	public M9click()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/tp230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("The Painist");
		...
		moviename = new JTextField("The Painist");
		...
		genre = new JTextField("Biography,Drama,Music");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\The Painist.mp4");
