...
public class M3clickpop implements ActionListener
{
	JFrame Framem1;
	...
	public M3clickpop()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/gf230.jpg"));
		...
		moviename = new JTextField("GoodFellas");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Goodfellas.mp4");
