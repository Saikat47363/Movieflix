...
public class M2clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M2clickmovie()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/3ed230.jpg"));
		...
		moviename = new JTextField("3-Idiots");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\3 idiots.mp4");
