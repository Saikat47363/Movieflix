...
public class M8clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M8clickmovie()
	{
		...
		moviename = new JTextField("Psyco");
		...
		genre = new JTextField("Horror,Thriller,Mystery");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Psycho.mp4");
