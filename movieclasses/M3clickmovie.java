...
public class M3clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M3clickmovie()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/ag230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Argentina,1985");
		...
		moviename = new JTextField("Argentina,1985");
		...
		genre = new JTextField("Biography,Crime,Drama");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Argentina 1985.mp4");
