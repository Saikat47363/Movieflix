...
public class M7clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M7clickmovie()
	{
		...
		moviename = new JTextField("Parasite");
		...
		genre = new JTextField("Drama,Thriller");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Parasite.mp4");
