...
public class M3clickseries implements ActionListener
{
	JFrame Framem1;
	...
	public M3clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/hns230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Hide and Seek");
		...
		moviename = new JTextField("Hide and Seek");
		...
		genre = new JTextField("Crime,Drama,Thriller");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Hide and Seek.mp4");
