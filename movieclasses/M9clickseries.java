...
public class M9clickseries implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,m1seriesbtn,m1reqbtn,m1backbtn,s,exitm1,m1popbtn,m1,m1lbl,m2,m2lbl,addlistbtn;
	private JPanel m1panel,m1panel3;
	
	public M9clickseries()
	{
		...
		moviename = new JTextField("Dexter");
		...
		genre = new JTextField("Drama,Crime,Mystery");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Dexter.mp4");
