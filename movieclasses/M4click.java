...
public class M4click implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,m1seriesbtn,m1reqbtn,m1backbtn,exitm1,m1popbtn,m1,s,m1lbl,m2,m2lbl,addlistbtn;
	...
	public M4click()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/bb230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Breaking Bad");
		...
		moviename = new JTextField("Breaking Bad");
		...
		release = new JTextField("2008-2013");
		...
		genre = new JTextField("Action,Adventure,Fantacy");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Breaking Bad.mp4");
