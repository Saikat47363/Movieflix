...
public class M11clickseries implements ActionListener
{
	JFrame Framem1;
	...
	public M11clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/hannibal230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Hannibal");
		...
		moviename = new JTextField("Hannibal");
		...
		genre = new JTextField("Drama,Crime,Horror");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Hannibal.mp4");
