...
public class M2clickseries implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,m1seriesbtn,m1reqbtn,s,m1backbtn,exitm1,m1popbtn,m1,m1lbl,m2,m2lbl,addlistbtn;
	private JPanel m1panel,m1panel3;
	
	public M2clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/got230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Game of Thrones");
		...
		moviename = new JTextField("Game of Thrones");
		...
		genre = new JTextField("Action,Adventure,Drama");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Game of Thrones.mp4");
