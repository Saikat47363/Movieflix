...
public class M1click implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,m1seriesbtn,m1reqbtn,s,m1backbtn,exitm1,m1,m1lbl,m2,m2lbl,m1popbtn,addlistbtn;
	...
	public M1click()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/fg230.jpg"));
		...
		moviename = new JTextField("Forrest Gump");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Forrest Gump.mp4");
