...
public class M12clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	private JButton m1searchlbl,m1moviebtn,m1seriesbtn,m1reqbtn,m1backbtn,exitm1,m1popbtn,s,m1,m1lbl,m2,m2lbl,addlistbtn;
	private JPanel m1panel,m1panel3;
	
	public M12clickmovie()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/tcnj230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("The Conjuring");
		...
		moviename = new JTextField("The Conjuring");
		...
		genre = new JTextField("Horror,Mystery,thriller");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\The Conjuring.mp4");
