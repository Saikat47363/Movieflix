...
public class M11clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M11clickmovie()
	{
		...
		genre = new JTextField("Action,Drama,War");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\1917.mp4");
