...
public class M6clickmovie implements ActionListener
{
	JFrame Framem1;
	...
	public M6clickmovie()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/abm230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("A Beautiful Mind");
		...
		moviename = new JTextField("A Beautiful Mind");
		...
		genre = new JTextField("Biography,Drama");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\A Beautiful Mind.mp4");
