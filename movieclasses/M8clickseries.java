...
public class M8clickseries implements ActionListener
{
	JFrame Framem1;
	...
	public M8clickseries()
	{
		...
		//MOVIE 1
		m1 = new JButton();
        m1.setIcon(new ImageIcon("images/pb230.jpg"));
        m1.setBounds(350, 150, 230, 355);
        m1.setCursor(new Cursor(Cursor.HAND_CURSOR));
        m1lbl = new JButton("Peaky Blinders");
		...
		moviename = new JTextField("Peaky Blinders");
...
public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==addlistbtn)
		{
			try{
				...
				File dfile = new File("downloads\\Peaky Blinders.mp4");
